...
def save_feature_to_img(selected_layer, x):
    #to numpy
    feature = x
    feature = feature.cpu()
    ...
    # cv2.imwrite('./image_middle/img%s.jpg' % str(selected_layer), feature)
    misc.imsave('./image_middle/img%s.png' % str(selected_layer), feature[..., :3])
