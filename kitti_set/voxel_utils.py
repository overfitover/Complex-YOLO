...
def load_calib(calib_dir):
    ...
    """
    :param calib_dir: 加载calib文件, 返回转换需要的参数
    :return: P2  R0_rect  Tr_velo_to_cam    (4, 4)
    """
...
def lidar_to_camera_point(points, T_VELO_2_CAM=None, R_RECT_0=None):
    ...
    points = np.matmul(R_RECT_0, points).T            # (4, N) -> (N, 4)
    points = points[:, 0:3]
    return points.reshape(-1, 3)
